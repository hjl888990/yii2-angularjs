...
angular.module('ui.bootstrap.datetimepicker', ['ui.bootstrap.dateparser', 'ui.bootstrap.position'])
    ...
    .directive('datetimePicker', ['$compile', '$parse', '$document', '$timeout', '$position', 'dateFilter', 'dateParser', 'uiDatetimePickerConfig', '$rootScope', 'timepickerConfig', 
        function ($compile, $parse, $document, $timeout, $position, dateFilter, dateParser, uiDatetimePickerConfig, $rootScope, timepickerConfig) {
            return {
                restrict: 'A',
                require: 'ngModel',
                scope: {
                ...
                link: function (scope, element, attrs, ngModel) {
                    ...
                    if (attrs.datetimePicker.indexOf('h') != -1) {
                        // 24小时制
                        showMeridian = 'true';
                    } else if (attrs.showMeridian == 'true') {
                        showMeridian = 'true';
                    }
                    var popupEl = angular.element('' +
                        ...
                        '<div timepicker show-meridian="'+ showMeridian +'" style="margin:0 auto"></div>' +
                        '</div>');
